...
import {DSRoles} from "../lib/ds-roles/src/roles.sol";
import {DSGuard} from "../lib/ds-guard/src/guard.sol";
import {WETH9_} from "../lib/ds-weth/src/weth9.sol";

import "../contracts/DssDeploy.sol";
import {GemJoin} from "../lib/dss/contracts/join.sol";
...
contract DssDeployTestBase is DSTest, ProxyActions {
    ...
    function deployKeepAuth() public {
        ...
        // dssDeploy.deployPause(0, DSAuthority(authority));
