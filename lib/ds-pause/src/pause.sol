...
import {DSNote} from "../../ds-note/src/note.sol";
import {DSAuth, DSAuthority} from "../../ds-auth/src/auth.sol";
...
contract DSPause is DSAuth, DSNote {
    ...
    function setDelay(uint delay_) public payable note wait {
        delay = delay_;
    }
    ...
    // constructor(uint delay_, address owner_) public {
    //     delay = delay_;
    //     owner = owner_;
    //     proxy = new DSPauseProxy();
    // }
