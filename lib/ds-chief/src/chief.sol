...
import {DSThing} from  "../../ds-thing/src/thing.sol";
import  {DSAuthority} from "../../ds-auth/src/auth.sol";
import  {DSRoles} from "../../ds-roles/src/roles.sol";


// The riAuthay to use this contract is probably to mix it with some kind
